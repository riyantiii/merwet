...
<head>
	...
	<!-- Page Title -->
	<title>DESA MERTAPADA WETAN</title>
...
<section data-name="slide-7" class="slide fade-6 kenBurns">
  <div class="content">
      <div class="wrap">
        <br><br>
      <center><img width="170" src="assets/img/crb.png" alt="BBC"/>
        <div class="fix-9-12 toCenter"><br>
          <h1 class="ae-1">DESA MERTAPADA WETAN</h1>
          <p class="ae-2"><span class="opacity-8">Selamat Datang DI Website Resmi Desa Mertapada Wetan.</span></p>

          
          <!-- remove class tintLogos class to disable color change of the logo images -->
          <ul class="flex grid-190">
          <div class="ae-5">
                <div class=""><a href="merwet"><img width="218" height="" src="assets/img/32-img-desa.png" alt="DESA"/></a>
              </li>
            <ul class="flex grid-100">
              <div class=" ae-5">
                <div class=""><a href="merwet"><img width="215" height="" src="assets/img/msyrkt.png" alt="DESA"></a>
                </div>
              </div>
            </li>
            <div class="ae-6">
              <div class=""><a href="merwet"><img width="215" height="" src="assets/img/berita.png" alt="DESA"></a>
                </div>
            </div>
            </li>
              <div class="ae-6">
              <div class=""><a href="merwet"><img width="220" height="" src="assets/img/layananan.png" alt="DESA"></a>
                </div>
              </div>
            </li>
              <div class="ae-7">
              <div class=""><a href="merwet"><img width="220" height="" src="assets/img/pnduduk.png" alt="DESA"></a>
                </div>
              </div>
            </li>
  ...
  <div class="background" style="background-image:url(assets/img/background/img-31.png)"></div>
</section>
